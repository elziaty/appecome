...
use Modules\Gateways\Http\Controllers\ShippingConfigController;
use Modules\Gateways\Http\Controllers\ShippingController;
...
Route::group(['prefix' => 'shipping', 'as' => 'shipping.'], function () {
    // Ship order route
    Route::post('/ship-order', [ShippingController::class, 'shipOrder'])->name('ship.order');
});
...
Route::group(['prefix' => 'admin/shipping'], function () {
    Route::group(['prefix' => 'configuration', 'as' => 'configuration.', 'middleware' => ['admin']], function () {
        Route::get('addon-shipping-get', [ShippingConfigController::class, 'shipping_config_get'])->name('addon-shipping-get');
        Route::put('addon-shipping-set', [ShippingConfigController::class, 'shipping_config_set'])->name('addon-shipping-set');
    });
});
