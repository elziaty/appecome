...
use Modules\Gateways\Http\Middleware\InjectShippingMiddleware;
use Illuminate\Routing\Events\RouteMatched;
use Modules\Gateways\Listeners\RouteMatchedHandler;
...
class GatewaysServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if ($info['is_published']) {
            ...
            $this->app['router']->aliasMiddleware('shipping_gateways', InjectShippingMiddleware::class);

            // Register the RouteMatched event listener
            $this->app['events']->listen(RouteMatched::class, RouteMatchedHandler::class);
        }
